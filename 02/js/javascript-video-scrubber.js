...
var totalFrames = 1661; // the number of images in the sequence of JPEG files (this could be calculated server-side by scanning the frames folder)
...
function getYOffset() { // get distance scrolled from the top
  ...
  //console.log('LOG: ' + pageY);
  if (pageY <= 3449) {
    $('.box1').addClass('hideBox').removeClass('showBox');
    $('.box2').addClass('hideBox').removeClass('showBox');
    $('.box3').addClass('hideBox').removeClass('showBox');
  }
  else if (pageY >= 3450 && pageY <= 6699) {
    $('.box1').addClass('showBox').removeClass('hideBox');
    $('.box2').addClass('hideBox').removeClass('showBox');
    $('.box3').addClass('hideBox').removeClass('showBox');
  }
  else if (pageY >= 6700 && pageY <= 25899) {
    $('.box1').addClass('hideBox').removeClass('showBox');
    $('.box2').addClass('hideBox').removeClass('showBox');
    $('.box3').addClass('hideBox').removeClass('showBox');
  }
  else if (pageY >= 25900 && pageY <= 30999) {
    $('.box1').addClass('hideBox').removeClass('showBox');
    $('.box2').addClass('showBox').removeClass('hideBox');
    $('.box3').addClass('hideBox').removeClass('showBox');
  }
  else if (pageY >= 31000 && pageY <= 34499) {
    $('.box1').addClass('hideBox').removeClass('showBox');
    $('.box2').addClass('hideBox').removeClass('showBox');
    $('.box3').addClass('hideBox').removeClass('showBox');
  }
  else if (pageY >= 35000 && pageY <= 46199) {
    $('.box1').addClass('hideBox').removeClass('showBox');
    $('.box2').addClass('hideBox').removeClass('showBox');
    $('.box3').addClass('showBox').removeClass('hideBox');
  }
  else if (pageY >= 35000) {
    $('.box1').addClass('hideBox').removeClass('showBox');
    $('.box2').addClass('hideBox').removeClass('showBox');
